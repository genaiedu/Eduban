#!/bin/bash
# EDUBAN starten: Schueler mit Datenbank — Doppelklick genügt!
cd "$(dirname "$0")"
PORT=8080
...
echo "Öffne EDUBAN (Schueler mit Datenbank) im Browser..."
...
echo ""
echo "EDUBAN (Schueler mit Datenbank) läuft auf $URL"
