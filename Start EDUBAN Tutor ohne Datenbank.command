#!/bin/bash
# EDUBAN starten: Tutor ohne Datenbank — Doppelklick genügt!
cd "$(dirname "$0")"
PORT=8080
...
URL="http://localhost:$PORT/tutor-ohne-datenbank.html"
echo "Öffne EDUBAN (Tutor ohne Datenbank) im Browser..."
...
echo ""
echo "EDUBAN (Tutor ohne Datenbank) läuft auf $URL"
